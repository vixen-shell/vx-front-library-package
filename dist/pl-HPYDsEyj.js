import { g as y, c as g } from "./_commonjsHelpers-DaMA6jEr.js";
import k from "dayjs";
function w(o, c) {
...
(function(o, c) {
  (function(a, e) {
    ...
    var l = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_"), m = "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_"), z = /D MMMM/, u = function(t, s) {
      return z.test(s) ? l[t.month()] : m[t.month()];
    };
    u.s = m, u.f = l;
...
var f = d.exports;
const Y = /* @__PURE__ */ y(f), b = /* @__PURE__ */ w({
  __proto__: null,
  default: Y
}, [f]);
export {
